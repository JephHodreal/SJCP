...
<body>
    <div class="content-wrapper">
       <!-- Login Form -->
            ...
            <div class="nav-content">
                ...
                <div class="nav-item dropdown active">
                    ...
                    <div class="dropdown-content">
                        ...
                        <div onclick="window.location.href='page_SCHEDULEEVENT.php'" class="nav-item" <?php if (!isset($_SESSION['isLoggedIn']) || $_SESSION['isLoggedIn'] == false) {
                                                    echo 'onclick="openLogin()"';
                                                } else {
                                                } ?>>
                            Schedule Event
                        </div>
                        <div onclick="window.location.href='page_APPOINTMENTS.php'" class="nav-item active" <?php if (!isset($_SESSION['isLoggedIn']) || $_SESSION['isLoggedIn'] == false) {
                                                    echo 'onclick="openLogin()"';
                                                } else {
                                                } ?>>
                            My Appointment
                ...
                if (!isset($_SESSION['isLoggedIn']) || $_SESSION['isLoggedIn'] == false) {
                    ...
                    <div class="dropdown-content">
                        ...
                        <div class="nav-item" onclick="openclose(logoutForm)">Log-Out</div>
                    </div>
                <?php '</div>';
                }
                ?>
                ...
                <div class="body-content">
                    <div class="filter-cont">
                        ...
                        <div class="view-header" onclick="showoption('statusoptions')">
                            ...
                            <form class="record-filter" id="statusoptions" action="page_LANDING.php" method="post">
                    ...
                    <div class="details">
                            <?php 
                                ...
                                $query = "SELECT * FROM appointment_details WHERE appointment_status = '$status' AND email = '$email'  LIMIT $startFrom, $recordsPerPage";
                                $sql = "SELECT COUNT(*) AS total FROM appointment_details WHERE appointment_status = '$status' AND email = '$email'"; ?>
                                        ...
                                        ?>
                                            ...
                                            <div class="indiv-cont">
                                                <div>
                                                    <table>
                                                        <tr>    
                                                            <td class="th"><p class="reference"><?php echo $row[1] ?></p> <p class="<?php echo $row[10]?>"> <?php echo $row[10] ?></p></td>
                                                            <td></td>
                                                            <td>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                                            <td><p><?php echo date('M d, Y', strtotime($row[6]))?></p></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                                            <td><p><?php echo date('h:m:s A', strtotime($row[7]))?></p></td>
                                                        </tr>
                                                        <?php } ?>
                                                            ...
                                                            <div class="popupCover" id="<?php echo $resched?>">
                                                                <div class="popupForm">
                                                                    ...
                                                                    <div class="form-btnarea">
                                                                        ...
                                                                        <button type="Submit" class="buttonyes" name="reschedYes"> Yes </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="form-area">
                                                                        <div class="reason-container">
                                                                            <div class="form-reason">
                                                                                <div>
                                                                                    <input type="radio" name="reason" id="cop" value="Change of Plans" onclick="hideinput(otherinput)"> 
                                                                                    <label for="cop">Change of Plans</label><br>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" name="reason" id="lop" value="Lack of Preparetion" onclick="hideinput(otherinput)">
                                                                                    <label for="lop">Lack of Preparation</label><br>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" name="reason" id="uta" value="Unable to attend" onclick="hideinput(otherinput)">
                                                                                    <label for="uta">Unable to attend</label><br>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" name="reason" id="emerg" value="Emergency" onclick="hideinput(otherinput)">
                                                                                    <label for="emerg">Emergency</label><br>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" name="reason" id="cs" value="Conflicting Schedule" onclick="hideinput(otherinput)">
                                                                                    <label for="cs">Conflicting Schedule</label><br>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" name="reason" id="ps" value="Personal Stuff" onclick="hideinput(otherinput)">
                                                                                    <label for="ps">Personal Matters</label><br>
                                                                                </div>  
                                                                                <div>
                                                                                    <input type="radio" name="reason"id="other" value="other" onclick="showinput(otherinput)">
                                                                        ...
                                                                        <div class="form-btnarea">
                                                                            ...
                                                                            <button type="submit" class="buttonresched popupresched" name="reasonsubmit">Submit</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <script src="jsAPPOINTMENTS.js"></script>
    </div>
</body>
